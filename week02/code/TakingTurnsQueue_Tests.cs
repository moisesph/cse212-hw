...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 1. It was adding the persons at the beginning, not at the end
    ...
    // Defect(s) Found: Not Errors found
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The program didn't know  that 0 means infinite
    ...
    // Defect(s) Found: At the beginning I used Turn 99999 to pass it as infinite, but I change it as a rule inside the element to be "infinite" as a bool
    ...
    // Defect(s) Found: No errors founded
